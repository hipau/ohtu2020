...
public class Stepdefs {
    ...
    public void validUsernameAndMatchingPasswordsAreEntered(String username, String password) throws Throwable {
    ...
    public void tooShortUsernameAndMatchingPasswordsAreEntered(String username, String password) throws Throwable {
        registerUserWith(username, password, password);
    }
    
    @When("a valid username {string} and a too short password {string} and matching password confirmation are entered")
    public void validUsernameAndTooShortPasswordsAreEntered(String username, String password) throws Throwable {
        registerUserWith(username, password, password);
    }
    
    @When("a valid username {string} and password {string} and non-matching password confirmation are entered")
    public void validUsernameAndNonMatchingPasswordsAreEntered(String username, String password) throws Throwable {
        registerUserWith(username, password, password + 'a');
    }
    
    @Then("user is not created and error {string} is reported")
    public void userNotCreated(String error) throws Throwable {
    ...
    private void registerUserWith(String username, String password, String passwordConfirmation) {
